...
### 前言
由于原作者暂停维护该项目，本fork对原项目进行部分修改，包括README内容、规则生成等等

同时本fork项目遵守原作者规定的CC 4.0协议及保持使用CC 4.0许可证。

[LICENSE](https://raw.githubusercontent.com/h2y/Shadowrocket-ADBlock-Rules/master/LICENSE)

------------------------------------------------------

这里是一系列好用的翻墙规则，针对 [Shadowrocket](https://liguangming.com/Shadowrocket) 开发，支持广告过滤。规则定义了哪些网站可以直连，哪些必须走代理，规则是一个纯文本文件，无法提供翻墙功能。
使用 Python 按照一定的规则和模板定期自动生成，并且使用开源的力量，集众人之力逐渐完善。
